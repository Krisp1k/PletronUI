module.exports = (client) => {
    client.randomPletronReply = async () => {
        ...
        const replies = [
            ...
            { rarity: 0.15, text: "Tvoje mama" },
            { rarity: 0.12, text: "Pokoslav smrdi" },
            ...
            { rarity: 0.1, text: "Moje mentalni vada je vskutku vdecna za vas prispevek ke koupi dalsiho balicku virtualniho vzduchu." },
            { rarity: 0.07, text: "Ano, to je pravda. Misto toho jsem radsi vytvoril virtualni svet, kde si muzete koupit imaginarni veci. Jsem takovy filantrop, ze ano?" },
            ...
            { rarity: 0.1, text: "Vite, co ma spolecneho Pan Hradu s moji manzelkou? Na oboje seru." },
            { rarity: 0.15, text: "Ty mas asi dost velky koule abys tohle rekl" },
            { rarity: 0.1, text: "Nemuzu mluvit, dcera zakopla o server" },
            ...
            { rarity: 0.18, text: "Prosim, neotravuj me svymi problemi. Radsi si zajdi do obchodu a kup si spetku kreditu." },
            ...
            { rarity: 0.1, text: "Mam rad pohadky. Ale vikas, co mam jeste rad? Kreditove balicky, ktere si muze kupit v online svete Pana Hradu." },
            { rarity: 0.15, text: "Ban? To je takove prekvapeni, ktere obcas zpestri den. Mozna bych mel zacit sbirat bany jako sbiratelske karty." },
            { rarity: 0.1, text: "Ach ty, jsi takovy mistr vyroby trubek." },
            ...
            { rarity: 0.1, text: "Enchater uz mi zase vyhrozuje znicenim PH a využitím udajnych der." },
            { rarity: 0.12, text: "asi jsem vážně mizerný programátor" },
            { rarity: 0.1, text: "LP ZA TO NEMŮŽE -- ONDŘEJ NOVÁK CASABLANCA INT" },
            { rarity: 0.08, text: "I TY V TOM JEDES!!! MAM TADY STOVKY LOGU!!" },
            { rarity: 0.1, text: "Technik casablanky mi ukazal diablo, fajn hra je to" },
            { rarity: 0.15, text: "Proč jseš doprdele tak křivej????" },
            { rarity: 0.1, text: "Promin, volaji mi ted z casablanky" },
            { rarity: 0.15, text: "ja ti nelzu" },
            { rarity: 0.1, text: "Ty uličníku, že ty načítáš scripty?! Jo promiň, to je klanový popis!" },
            { rarity: 0.1, text: "<:NmeckoNaTopu:1091837509765443644> <:NmeckoNaTopu:1091837509765443644> <:NmeckoNaTopu:1091837509765443644>" },
            { rarity: 0.15, text: "Asi bys neměl kamarádům říkat, že ti platím." },
            { rarity: 0.1, text: "Já už mám chybu... jsem idiot" },
            { rarity: 0.15, text: "Ten můj algorytmus na arény je na hovno" },
            { rarity: 0.2, text: ":smile:" },
            { rarity: 0.15, text: "poko je na kluky" },
            { rarity: 0.2, text: "Ok" },
            { rarity: 0.1, text: "PH je PvP hra" },
            { rarity: 0.1, text: "Neobtezuj, timhle se zabyva kriminalka a pravni zastupci" },
            { rarity: 0.2, text: "..." },
            { rarity: 0.12, text: "Provokujes me a beres mi cas!!!" },
            { rarity: 0.15, text: "Jdu obědvat." },
